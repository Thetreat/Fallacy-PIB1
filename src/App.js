...
import { Grid, IconButton, AppBar, Toolbar, Typography } from '@material-ui/core';
...
function App() {
	...
	[
		{
			...
			"Image": "",
			"Answers": "{x:183,y:425},{x:340,y:334},{x:480,y:432}",
			"Solution": "",
			"Difficulty": "0.25"
		},
		{
		...
		},
		{
			...
			"Image": "",
			"Answers": "{x:179,y:154},{x:256,y:174}+{x:427,y:127},{x:452,y:116}",
			"Solution": "",
			"Difficulty": "0.90"
		},
		{
	...
	window.user = new User("Rodrigo");
	
	return (
		<div className="App">
			<header className="App-header">
			<Router>
			<AppBar position="static" style={{background:"#FF8E53 30%"}}>
			<Toolbar>
